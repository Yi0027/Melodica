// Views,ArtworkPresetPickerView.swift
import SwiftUI
import AppKit

struct ArtworkPresetPickerView: View {
                    ...
                    Button {
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 6)
                                .fill(selectedGroupID == group.id ? Color.accent.opacity(0.12) : Color.clear)
                        )
                ...
                Image(nsImage: image)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 8)
                            .stroke(
                                selectedArtworkPath == path ? Color.accent : Color.clear,
                                lineWidth: 2
                            )
                    )
            } else {
