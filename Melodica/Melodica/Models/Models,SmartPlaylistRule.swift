...
enum SmartPlaylistRule: Identifiable, Codable, Hashable {
    ...
    var kind: Kind {
        ...
        case .artistContains:       return .text
        case .artistEquals:         return .text
        case .albumContains:        return .text
        case .albumEquals:          return .text
        case .genreContains:        return .text
        case .genreEquals:          return .text
        case .yearGreaterThan:      return .number
        case .yearLessThan:         return .number
        case .yearEquals:           return .number
        case .durationGreaterThan:  return .number
        case .durationLessThan:     return .number
        case .hasLyrics:            return .flag
        case .hasReplayGain:        return .flag
        case .isFavorite:           return .flag
        }
    }
    ...
    var displayValue: String {
        switch self {
        case .titleContains(let v):       return v
        case .artistContains(let v):      return v
        case .artistEquals(let v):        return v
        case .albumContains(let v):       return v
        case .albumEquals(let v):         return v
        case .genreContains(let v):       return v
        case .genreEquals(let v):         return v
        case .yearGreaterThan(let v):     return String(v)
        case .yearLessThan(let v):        return String(v)
        case .yearEquals(let v):          return String(v)
        case .durationGreaterThan(let v): return formatDuration(v)
        case .durationLessThan(let v):    return formatDuration(v)
        case .hasLyrics(let v):           return v ? "YES" : "NO"
        case .hasReplayGain(let v):       return v ? "YES" : "NO"
        case .isFavorite(let v):          return v ? "YES" : "NO"
        }
    }
